...
public class Macerator
    extends StackableController<Macerator, MaceratorProcessingLogic> {

  private static IStructureDefinition<Macerator> STRUCTURE_DEFINITION = null;

  public Macerator() { super(); }
  ...
  public IStructureDefinition<Macerator> getStructureDefinition() {
    if (STRUCTURE_DEFINITION == null) {
      STRUCTURE_DEFINITION =
          StructureDefinition.<Macerator>builder()
              ...
              .addShape(STACKABLE_START,
                        transpose(new String[][] {
                            {" G~F ", "AAAAA", "AAAAA", "AAAAA", " AAA "},
                        }))
              .addElement(
                  'A', ofMuTECasings(ENERGY_INPUT.getValue(),
              ...
              .addElement(
                  'B', ofMuTECasings(
                           ...
                           GT_MultiTileCasing.Macerator.getCasing()))
              .addElement(
                  'C', ofMuTECasings(NOTHING.getValue(),
                                     GT_MultiTileCasing.Macerator.getCasing()))
              .addElement(
                  'D', ofMuTECasings(NOTHING.getValue(),
                                     GT_MultiTileCasing.Macerator.getCasing()))
              .addElement('F', ofMuTECasings(NOTHING.getValue(), MOTOR_CASINGS))
              .addElement('G',
                          ofMuTECasings(NOTHING.getValue(), INVENTORY_CASINGS))
              .build();
    }
