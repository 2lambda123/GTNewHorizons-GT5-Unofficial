...
public class DistillationTower
    extends StackableController<DistillationTower,
                                DistillationTowerProcessingLogic> {

  private static IStructureDefinition<DistillationTower>
  ...
  public IStructureDefinition<DistillationTower> getStructureDefinition() {
    if (STRUCTURE_DEFINITION_MEGA == null) {
      STRUCTURE_DEFINITION_MEGA =
          StructureDefinition.<DistillationTower>builder()
              .addShape(STACKABLE_START,
                        transpose(
                            // spotless:off
                            new String[][] {
                                {"                   ", "                   ",
                                ...
                                {"     CCCCC         ", "     CCCCC         ",
                                 "     CCCCC         ", "                   ",
                                 "  CCCCCCCCCCC      ", "  CAAAAAAAAAC      ",
                                 "CCCACCCCCCCACCC    ", "CAACAAAAAAACAAC    ",
                                 "CACAADDDDDAACAC    ", "CACADDDDDDDACACCCCC",
                                 "CACADDAAADDACACCCCC", "CACADDAAADDACACCCCC",
                                 "CACADDAAADDACACCCCC", "CACADDDDDDDACACCCCC",
                                 "CACAADDDDDAACAC    ", "CAACAAAAAAACAAC    ",
                                 "CCCACCCCCCCACCC    ", "  CAAAAAAAAAC      ",
                                 "  CCCCCCCCCCC      "}}))
              ...
              .addElement('E',
                          GT_StructureUtility.ofFrame(Materials.StainlessSteel))
              ...
              .addElement(
                  'D', GT_StructureUtility.ofCoil(
                           (tile, meta) -> {}, (tile) -> HeatingCoilLevel.None))
              .build();
    }
  ...
  public String getLocalName() { return "Distillation Tower"; }
