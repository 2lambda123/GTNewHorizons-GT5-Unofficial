...
public class LaserEngraver
    extends ComplexParallelController<LaserEngraver,
                                      LaserEngraverProcessingLogic> {

  private static IStructureDefinition<LaserEngraver> STRUCTURE_DEFINITION =
      null;
  ...
  public boolean checkMachine() {
    ...
    if (maxComplexParallels > 4) {
      ...
      if (!checkPiece(STRUCTURE_PIECE_T5, buildState.getCurrentOffset()))
        return buildState.failBuilding();
    }
    if (maxComplexParallels > 5) {
      buildState.addOffset(STRUCTURE_OFFSET_T6);
      if (!checkPiece(STRUCTURE_PIECE_T6, buildState.getCurrentOffset()))
        return buildState.failBuilding();
    }
  ...
  public void construct(ItemStack trigger, boolean hintsOnly) {
    ...
    if (maxComplexParallels > 4) {
      buildState.addOffset(STRUCTURE_OFFSET_T5);
      buildPiece(STRUCTURE_PIECE_T5, trigger, hintsOnly,
                 buildState.getCurrentOffset());
    }
    if (maxComplexParallels > 5) {
      buildState.addOffset(STRUCTURE_OFFSET_T6);
      buildPiece(STRUCTURE_PIECE_T6, trigger, hintsOnly,
                 buildState.getCurrentOffset());
    }
    buildState.stopBuilding();
  }
  ...
  public IStructureDefinition<LaserEngraver> getStructureDefinition() {
    if (STRUCTURE_DEFINITION == null) {
      STRUCTURE_DEFINITION =
          StructureDefinition.<LaserEngraver>builder()
              .addShape(STRUCTURE_PIECE_T1,
                        transpose(
                            // spotless:off
                            new String[][] {{"ACADA", "AAAAA", "AAAAA"},
                                            {"GGA~A", "H   I", "GGAAA"},
                                            {"AAAAA", "ABBBA", "AAAAA"}}))
              .addShape(STRUCTURE_PIECE_T2,
                        new String[][] {{"       ", "       ", "       ",
                                        ...
                                        {"  K    ", "FBF FBF", " G   G ",
                                         " G   G ", " G   G ", "FBF FBF"},
                                        {" KKKKK ", "BIB BIB", "G G G G",
                                         "G G G G", "G G G G", "BHB BHB"},
                                        {" K   K ", "FBF FBF", " G   G ",
                                         " G   G ", " G   G ", "FBF FBF"},
                                        {" K   K ", "       ", "       ",
                                         "       ", "       ", "       "},
              ...
              .addShape(
                  ...
                  new String[][] {
                      {"              ", "   BBBBB  FBF ", "   BGGGB   G  ",
                       "   BGGGB   G  ", "   BMLMB   G  ", "   BBBBB  FBF "},
                      {"     KKKKKKK  ", "  BBAAABB BIB ", "  B     B G G ",
                       "  B     B G G ", "  B     B G G ", "  BBBBBBB BHB "},
                      {"     K        ", "  BABBBAB FBF ", "  G     G  G  ",
                       "  G     G  G  ", "  M HHH M  G  ", "  BBBBBBB FBF "},
                      {"KKKKKK        ", "  BABIBAB     ", "  G     G     ",
                       "  G     G     ", "  L HHH L     ", "  BBBBBBB     "},
                      {"     K        ", "  BABBBAB FBF ", "  G     G  G  ",
                       "  G     G  G  ", "  M HHH M  G  ", "  BBBBBBB FBF "},
              ...
              .addShape(
                  ...
                  new String[][] {
                      {"             ", "FBF  BBBBB   ", " G   BGGGB   ",
                       " G   BGGGB   ", " G   BNLNB   ", "FBF  BBBBB   "},
                      {" KKKKKKK     ", "BIB BBAAABB  ", "G G B     B  ",
                       "G G B     B  ", "G G B     B  ", "BHB BBBBBBB  "},
                      {"       K     ", "FBF BABBBAB  ", " G  G     G  ",
                       " G  G     G  ", " G  N HHH N  ", "FBF BBBBBBB  "},
                      {"       KKKKKK", "    BABIBAB  ", "    G     G  ",
                       "    G     G  ", "    L HHH L  ", "    BBBBBBB  "},
                      {"       K     ", "FBF BABBBAB  ", " G  G     G  ",
                       " G  G     G  ", " G  N HHH N  ", "FBF BBBBBBB  "},
              ...
              .addShape(
                  ...
                  new String[][] {
                      {"              ", "   BBBBB  FBF ", "   BGGGB   G  ",
                       "   BGGGB   G  ", "   BOLOB   G  ", "   BBBBB  FBF "},
                      {"     KKKKKKK  ", "  BBAAABB BIB ", "  B     B G G ",
                       "  B     B G G ", "  B     B G G ", "  BBBBBBB BHB "},
                      {"     K        ", "  BABBBAB FBF ", "  G     G  G  ",
                       "  G     G  G  ", "  O HHH O  G  ", "  BBBBBBB FBF "},
                      {"     K        ", "  BABIBAB     ", "  G     G     ",
                       "  G     G     ", "  L HHH L     ", "  BBBBBBB     "},
                      {"     K        ", "  BABBBAB FBF ", "  G     G  G  ",
                       "  G     G  G  ", "  O HHH O  G  ", "  BBBBBBB FBF "},
                      ...
                      {"     K  ", "       ", "       ", "       ", "       "},
                      {"     K  ", "       ", "       ", "       ", "       "}})
              .addShape(STRUCTURE_PIECE_T6,
                        new String[][] {
                            {"             ", "FBF  BBBBB   ", " G   BGGGB   ",
                             " G   BGGGB   ", " G   BPLPB   ", "FBF  BBBBB   "},
                            {" KKKKKKK     ", "BIB BBAAABB  ", "G G B     B  ",
                             "G G B     B  ", "G G B     B  ", "BHB BBBBBBB  "},
                            {"       K     ", "FBF BABBBAB  ", " G  G     G  ",
                             " G  G     G  ", " G  P HHH P  ", "FBF BBBBBBB  "},
                            {"       K     ", "    BABIBAB  ", "    G     G  ",
                             "    G     G  ", "    L HHH L  ", "    BBBBBBB  "},
                            {"       K     ", "FBF BABBBAB  ", " G  G     G  ",
                             " G  G     G  ", " G  P HHH P  ", "FBF BBBBBBB  "},
              ...
              .addElement(
                  ...
                  ofMuTECasings(
                      FLUID_INPUT.getValue() | ITEM_INPUT.getValue() |
                          FLUID_OUTPUT.getValue() | ITEM_OUTPUT.getValue() |
                          ENERGY_INPUT.getValue(),
                      GT_MultiTileCasing.BlackLaserEngraverCasing.getCasing()))
              .addElement(
                  'C',
                  ofMuTECasings(NOTHING.getValue(), CLEANROOM_CASINGS,
                                GT_MultiTileCasing.LaserEngraver.getCasing()))
              .addElement(
                  'D',
                  ofMuTECasings(NOTHING.getValue(), WIRELESS_CASINGS,
                                GT_MultiTileCasing.LaserEngraver.getCasing()))
              ...
              .addElement('H',
                          ofMuTECasings(NOTHING.getValue(),
                                        GT_MultiTileCasing.Mirror.getCasing()))

              .addElement(
                  'G',
                  ofChain(ofBlockUnlocalizedName(IndustrialCraft2.ID,
                                                 "blockAlloyGlass", 0, true),
                          ofBlockUnlocalizedName(BartWorks.ID, "BW_GlasBlocks",
                                                 0, true),
                          ofBlockUnlocalizedName(BartWorks.ID, "BW_GlasBlocks2",
                                                 0, true),
                          ofBlockUnlocalizedName(
                              Thaumcraft.ID, "blockCosmeticOpaque", 2, false)))
              .addElement('I',
                          ofMuTECasings(NOTHING.getValue(), EMITTER_CASINGS))
              .addElement('K', ofBlock(GregTech_API.sBlockCasings3, 11))
              .addElement('L',
                          ofMuTECasings(NOTHING.getValue(), ROBOT_ARM_CASINGS))
              .addElement(
                  'M',
                  ofMuTECasings(
                      NOTHING.getValue(),
                      GT_MultiTileCasing.LaserEngraverUpgrade1.getCasing()))
              .addElement(
                  'N',
                  ofMuTECasings(
                      NOTHING.getValue(),
                      GT_MultiTileCasing.LaserEngraverUpgrade2.getCasing()))
              .addElement(
                  'O',
                  ofMuTECasings(
                      NOTHING.getValue(),
                      GT_MultiTileCasing.LaserEngraverUpgrade3.getCasing()))
              .addElement(
                  'P',
                  ofMuTECasings(
                      NOTHING.getValue(),
                      GT_MultiTileCasing.LaserEngraverUpgrade4.getCasing()))
              .build();
      buildState.stopBuilding();
    }
