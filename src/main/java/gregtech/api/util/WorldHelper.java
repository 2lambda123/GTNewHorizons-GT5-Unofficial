...
public class WorldHelper {
  ...
  getTileEntityAtSide(@Nonnull final ForgeDirection side,
                      @Nonnull final IBlockAccess world, final int x,
  ...
  getIInventoryAtSide(@Nonnull final ForgeDirection side,
                      @Nonnull final IBlockAccess world, final int x,
                      final int y, final int z) {
    final TileEntity te = getTileEntityAtSide(side, world, x, y, z);
    if (te instanceof IInventory teii)
      return teii;
    return null;
  }
}
