...
public class ComplexParallelProcessingLogic<
    P extends ComplexParallelProcessingLogic<P>>
  ...
  public int getDuration(int index) { return durations[index]; }

  public int getProgress(int index) { return progresses[index]; }
