...
public class ProcessingTask<T extends TaskHost & ProcessingLogicHost<P> &
                                          MachineProgress,
                                      P extends MuTEProcessingLogic<P>>
    extends TickableTask<T> {

  public ProcessingTask(@Nonnull T taskHost) { super(taskHost); }
