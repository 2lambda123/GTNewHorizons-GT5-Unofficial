...
public abstract class BaseTileEntity extends TileEntity
    implements IHasWorldObjectAndCoords, IIC2Enet, IGTEnet, ITileWithModularUI,
               IAddGregtechLogo, IGetGUITextureSet, IAddInventorySlots {
   ...
   * <p/>
   * "this" means that there is no TileEntity, while "null" means that it
   * doesn't know if there is even a TileEntity and still needs to check that if
   * needed.
   */
  private final TileEntity[] mBufferedTileEntities = new TileEntity[6];
  /**
   * If this TileEntity checks for the Chunk to be loaded before returning World
   * based values. The AdvPump hacks this to false to ensure everything runs
   * properly even when far Chunks are not actively loaded. But anything else
   * should not cause worfin' Chunks, uhh I mean orphan Chunks.
   */
  public boolean ignoreUnloadedChunks = true;
  /**
   * This Variable checks if this TileEntity is dead, because Minecraft is too
   * stupid to have proper TileEntity unloading.
   */
  ...
  getSideForPlayerPlacing(Entity aPlayer, ForgeDirection defaultFacing,
                          boolean[] aAllowedFacings) {
    ForgeDirection facingFromPlayer =
        GT_Utility.getSideFromPlayerFacing(aPlayer);
    if (facingFromPlayer != ForgeDirection.UNKNOWN &&
        aAllowedFacings[facingFromPlayer.ordinal()])
      return facingFromPlayer;
    for (final ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS)
      if (aAllowedFacings[dir.ordinal()])
        return dir;
  ...
  /**
   * Called automatically when the Coordinates of this TileEntity have been
   * changed
   */
  ...
  @Override
  public final Block getBlockAtSideAndDistance(ForgeDirection side,
                                               int aDistance) {
    return getBlock(getOffsetX(side, aDistance), getOffsetY(side, aDistance),
                    getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final byte getMetaIDAtSideAndDistance(ForgeDirection side,
                                               int aDistance) {
    return getMetaID(getOffsetX(side, aDistance), getOffsetY(side, aDistance),
                     getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final byte getLightLevelAtSideAndDistance(ForgeDirection side,
                                                   int aDistance) {
    return getLightLevel(getOffsetX(side, aDistance),
                         getOffsetY(side, aDistance),
                         getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final boolean getOpacityAtSideAndDistance(ForgeDirection side,
                                                   int aDistance) {
    return getOpacity(getOffsetX(side, aDistance), getOffsetY(side, aDistance),
                      getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final boolean getSkyAtSideAndDistance(ForgeDirection side,
                                               int aDistance) {
    return getSky(getOffsetX(side, aDistance), getOffsetY(side, aDistance),
                  getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final boolean getAirAtSideAndDistance(ForgeDirection side,
                                               int aDistance) {
    return getAir(getOffsetX(side, aDistance), getOffsetY(side, aDistance),
                  getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final TileEntity getTileEntityAtSideAndDistance(ForgeDirection side,
                                                         int aDistance) {
    if (aDistance == 1)
      return getTileEntityAtSide(side);
    return getTileEntity(getOffsetX(side, aDistance),
                         getOffsetY(side, aDistance),
                         getOffsetZ(side, aDistance));
  }
  ...
  @Override
  public final IInventory getIInventoryAtSideAndDistance(ForgeDirection side,
                                                         int aDistance) {
    final TileEntity tTileEntity =
        getTileEntityAtSideAndDistance(side, aDistance);
    if (tTileEntity instanceof IInventory)
      return (IInventory)tTileEntity;
    return null;
  }
  ...
  @Override
  public final IGregTechTileEntity getIGregTechTileEntity(int aX, int aY,
                                                          int aZ) {
    final TileEntity tTileEntity = getTileEntity(aX, aY, aZ);
  ...
  @Override
  public final IGregTechTileEntity getIGregTechTileEntityOffset(int aX, int aY,
                                                                int aZ) {
    final TileEntity tTileEntity = getTileEntityOffset(aX, aY, aZ);
    if (tTileEntity instanceof IGregTechTileEntity)
      return (IGregTechTileEntity)tTileEntity;
  ...
  @Override
  public final IGregTechTileEntity
  getIGregTechTileEntityAtSide(ForgeDirection side) {
    final TileEntity tTileEntity = getTileEntityAtSide(side);
    if (tTileEntity instanceof IGregTechTileEntity)
      return (IGregTechTileEntity)tTileEntity;
    return null;
  ...
  @Override
  public final IGregTechTileEntity
  getIGregTechTileEntityAtSideAndDistance(ForgeDirection side, int aDistance) {
    final TileEntity tTileEntity =
        getTileEntityAtSideAndDistance(side, aDistance);
    if (tTileEntity instanceof IGregTechTileEntity)
      return (IGregTechTileEntity)tTileEntity;
  ...
  public final Block getBlock(int aX, int aY, int aZ) {
    if (ignoreUnloadedChunks && crossedChunkBorder(aX, aZ) &&
        !worldObj.blockExists(aX, aY, aZ))
      return Blocks.air;
  ...
  public final TileEntity getTileEntityAtSide(ForgeDirection side) {
    ...
    if (mBufferedTileEntities[ordinalSide].xCoord == tX &&
        mBufferedTileEntities[ordinalSide].yCoord == tY &&
  ...
  public final void onAdjacentBlockChange(int ignoredAX, int ignoredAY,
                                          int ignoredAZ) {
    clearNullMarkersFromTileEntityBuffer();
  }
  ...
  public void updateNeighbours(int mStrongRedstone, int oStrongRedstone) {
    ...
    for (final ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) {
      final int x1 = xCoord + dir.offsetX, y1 = yCoord + dir.offsetY,
                z1 = zCoord + dir.offsetZ;
      ...
      if (worldObj.blockExists(x1, y1, z1)) {
        ...
        if (((((mStrongRedstone | oStrongRedstone) >>> dir.ordinal()) & 1) !=
             0) &&
            getBlock(x1, y1, z1).isNormalCube()) {
          final int skipUpdateSide =
              dir.getOpposite()
          ...
          for (final ForgeDirection dir2 : ForgeDirection.VALID_DIRECTIONS) {
            final int x2 = x1 + dir2.offsetX, y2 = y1 + dir2.offsetY,
                      z2 = z1 + dir2.offsetZ;
            if (dir2.ordinal() != skipUpdateSide &&
                worldObj.blockExists(x2, y2, z2))
  ...
  public void markDirty() {
    // Avoid sending neighbor updates, just mark the chunk as dirty to make sure
    // it gets saved
   ...
   *
   * @return null if default implementation should be used, i.e. {@link
   *     IInventory#getStackInSlot}.
   *         Otherwise, a list of items to be displayed. Null element may be
   * contained.
   */
  @Nullable
  ...
  protected Supplier<Boolean> getValidator() { return () -> !this.isDead(); }

  public boolean useModularUI() { return false; }
  ...
  public ItemStackHandler getInventoryHandler() { return null; }
  ...
  public static final String
      ...
      BATTERY_SLOT_TOOLTIP_ALT =
          "GT5U.machines.battery_slot.tooltip.alternative",
      ...
      NEI_TRANSFER_VOLTAGE_TOOLTIP =
          "GT5U.machines.nei_transfer.voltage.tooltip";

  public static final int TOOLTIP_DELAY = 5;

  /**
   * Override this to add {@link com.gtnewhorizons.modularui.api.widget.Widget}s
   * for your UI.
   */
  public void addUIWidgets(ModularWindow.Builder builder,
                           UIBuildContext buildContext) {}

  public void bindPlayerInventoryUI(ModularWindow.Builder builder,
                                    UIBuildContext buildContext) {
    builder.bindPlayerInventory(buildContext.getPlayer(), 7,
                                getGUITextureSet().getItemSlot());
  }

  public String getLocalName() { return "Unknown"; }
  ...
  protected void addTitleTextStyle(ModularWindow.Builder builder,
                                   String title) {
    ...
    if (GT_Mod.gregtechproxy.mTitleTabStyle == 1) {
      ...
      tab.setDrawable(getGUITextureSet().getTitleTabDark())
          ...
          .setSize(titleWidth + (TAB_PADDING + TITLE_PADDING) * 2,
                   titleHeight + TAB_PADDING * 2 - 1);
      text.setPos(TAB_PADDING + TITLE_PADDING, -titleHeight);
    }
    builder.widget(tab).widget(text);
  }

  protected void addTitleItemIconStyle(ModularWindow.Builder builder,
                                       String title) {
    builder.widget(
  ...
  protected int getTitleColor() { return COLOR_TITLE.get(); }
  ...
  protected int getGUIWidth() { return 176; }

  protected int getGUIHeight() { return 166; }

  protected boolean doesBindPlayerInventory() { return true; }

  @Override
  public void add1by1Slot(ModularWindow.Builder builder,
  ...
  @Override
  public void add2by2Slots(ModularWindow.Builder builder,
                           IDrawable... background) {
    final ItemStackHandler inventoryHandler = getInventoryHandler();
    if (inventoryHandler == null)
      return;
  ...
  @Override
  public void add3by3Slots(ModularWindow.Builder builder,
                           IDrawable... background) {
    final ItemStackHandler inventoryHandler = getInventoryHandler();
    if (inventoryHandler == null)
      return;
  ...
  @Override
  public void add4by4Slots(ModularWindow.Builder builder,
                           IDrawable... background) {
    final ItemStackHandler inventoryHandler = getInventoryHandler();
    if (inventoryHandler == null)
      return;
  ...
  public void addCoverTabs(ModularWindow.Builder builder,
                           UIBuildContext buildContext) {
    /* Do nothing */
  }
  ...
  protected void addConfigurationCircuitSlot(ModularWindow.Builder builder) {
    ...
    builder.widget(
        new SlotWidget(
            new BaseSlot(inventoryHandler, ccs.getCircuitSlot(), true)) {
          @Override
          protected void phantomClick(ClickData clickData,
            ...
            if (clickData.shift) {
              ...
              final int index =
                  GT_Utility.findMatchingStackInList(tCircuits, cursorStack);
              if (index < 0) {
                int curIndex =
          ...
          protected void phantomScroll(int direction) {
            phantomClick(
                new ClickData(direction > 0 ? 1 : 0, false, false, false));
          }
          ...
          public List<String> getExtraTooltip() {
            ...
            .setOverwriteItemStackTooltip(list -> {
              list.removeIf(line
                            -> line.contains(StatCollector.translateToLocal(
                                   "gt.integrated_circuit.tooltip.0")) ||
                                   line.contains(StatCollector.translateToLocal(
                                       "gt.integrated_circuit.tooltip.1")));
              return list;
            })
            .disableShiftInsert()
  ...
  protected void openSelectCircuitDialog(ModularUIContext uiContext,
    ...
    uiContext.openClientWindow(
        player
        -> new SelectItemUIFactory(
               StatCollector.translateToLocal("GT5U.machines.select_circuit"),
               getStackForm(0), this::onCircuitSelected, circuits,
               GT_Utility.findMatchingStackInList(
                   circuits, inv.getStackInSlot(ccs.getCircuitSlot())))
  ...
  protected void onCircuitSelected(ItemStack selected) {
    ...
    GT_Values.NW.sendToServer(
        new GT_Packet_SetConfigurationCircuit(this, selected));
  ...
  protected Supplier<Integer> COLOR_TITLE =
      () -> getTextColorOrDefault("title", 0x404040);
  protected Supplier<Integer> COLOR_TITLE_WHITE =
      () -> getTextColorOrDefault("title_white", 0xfafaff);
  protected Supplier<Integer> COLOR_TEXT_WHITE =
      () -> getTextColorOrDefault("text_white", 0xfafaff);
  protected Supplier<Integer> COLOR_TEXT_GRAY =
      () -> getTextColorOrDefault("text_gray", 0x404040);
  protected Supplier<Integer> COLOR_TEXT_RED =
  ...
  public ItemStack getStackForm(long aAmount) { return null; }
}
