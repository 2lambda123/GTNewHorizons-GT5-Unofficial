...
public class MultiTileEntityProcess extends Process {
  ...
  @Nonnull private final IBlockAccess world;
  private int x, y, z;
  ...
  public void giveFacing(ForgeDirection facing) { this.facing = facing; }

  public void giveCasingData(int allowedModes, int currentMode, int controllerX,
